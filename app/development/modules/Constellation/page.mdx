...
It allows controllers, execution nodes, and interactive devices to discover each other, synchronize state, exchange commands, form sessions, and negotiate capabilities.
